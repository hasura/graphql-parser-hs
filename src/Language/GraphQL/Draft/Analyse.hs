module Language.GraphQL.Draft.Analyse
  ( Analysis (..),
    FieldAnalysis (..),
    FieldDef (..),
...
import Data.Foldable (foldl', find, Foldable (fold))
...
instance (Eq v, Hashable v) => Hashable (InputValue v)
...
getRootFieldNameFromOpType G.OperationTypeQuery = G.unsafeMkName "query_root"
getRootFieldNameFromOpType G.OperationTypeMutation = G.unsafeMkName "mutation_root"
getRootFieldNameFromOpType G.OperationTypeSubscription = G.unsafeMkName "subscription_root"
